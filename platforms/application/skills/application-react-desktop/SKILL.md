---
keyflow_id: sys_platforms_application_application_react_desktop_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/application/application-react-desktop.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/application/application-react-desktop.md`.
...
- Do not treat the compatibility path `platforms/application/application-react-desktop.md` as the canonical context-loading target.
