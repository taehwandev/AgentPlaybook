---
keyflow_id: sys_platforms_application_application_system_integration_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/application/application-system-integration.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/application/application-system-integration.md`.
...
- Do not treat the compatibility path `platforms/application/application-system-integration.md` as the canonical context-loading target.
