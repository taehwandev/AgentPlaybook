---
keyflow_id: sys_platforms_application_application_review_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/application/application-review.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/application/application-review.md`.
...
- Do not treat the compatibility path `platforms/application/application-review.md` as the canonical context-loading target.
