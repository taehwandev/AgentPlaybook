---
keyflow_id: sys_platforms_server_server_review_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/server/server-review.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/server/server-review.md`.
...
- Do not treat the compatibility path `platforms/server/server-review.md` as the canonical context-loading target.
