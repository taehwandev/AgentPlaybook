---
keyflow_id: sys_platforms_server_server_security_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/server/server-security.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/server/server-security.md`.
...
- Do not treat the compatibility path `platforms/server/server-security.md` as the canonical context-loading target.
