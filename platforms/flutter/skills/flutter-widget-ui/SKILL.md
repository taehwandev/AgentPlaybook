---
keyflow_id: sys_platforms_flutter_flutter_widget_ui_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/flutter/flutter-widget-ui.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/flutter/flutter-widget-ui.md`.
...
- Do not treat the compatibility path `platforms/flutter/flutter-widget-ui.md` as the canonical context-loading target.
