---
keyflow_id: sys_platforms_web_web_review_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/web/web-review.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/web/web-review.md`.
...
- Do not treat the compatibility path `platforms/web/web-review.md` as the canonical context-loading target.
