---
keyflow_id: sys_platforms_web_web_security_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/web/web-security.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/web/web-security.md`.
...
- Do not treat the compatibility path `platforms/web/web-security.md` as the canonical context-loading target.
