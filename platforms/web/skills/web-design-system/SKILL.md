---
keyflow_id: sys_platforms_web_web_design_system_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/web/skills/web-design-system/SKILL.md` or when work needs this Tao Agent OS guidance area.
