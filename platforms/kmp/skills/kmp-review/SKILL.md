---
keyflow_id: sys_platforms_kmp_kmp_review_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/kmp/kmp-review.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/kmp/kmp-review.md`.
...
- Do not treat the compatibility path `platforms/kmp/kmp-review.md` as the canonical context-loading target.
