...
Use when routed to `platforms/kmp/kmp-module-structure.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/kmp/kmp-module-structure.md`.
...
- Do not treat the compatibility path `platforms/kmp/kmp-module-structure.md` as the canonical context-loading target.
