---
keyflow_id: sys_platforms_ios_ios_review_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/ios/ios-review.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/ios/ios-review.md`.
...
- Do not treat the compatibility path `platforms/ios/ios-review.md` as the canonical context-loading target.
