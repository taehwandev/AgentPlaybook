---
keyflow_id: sys_platforms_swift_swift_review_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/swift/swift-review.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/swift/swift-review.md`.
...
- Do not treat the compatibility path `platforms/swift/swift-review.md` as the canonical context-loading target.
