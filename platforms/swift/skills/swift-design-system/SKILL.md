---
keyflow_id: sys_platforms_swift_swift_design_system_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/swift/swift-design-system.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/swift/swift-design-system.md`.
...
- Do not treat the compatibility path `platforms/swift/swift-design-system.md` as the canonical context-loading target.
