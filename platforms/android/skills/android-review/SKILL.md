...
Use when routed to `platforms/android/android-review.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/android/android-review.md`.
...
- Do not treat the compatibility path `platforms/android/android-review.md` as the canonical context-loading target.
