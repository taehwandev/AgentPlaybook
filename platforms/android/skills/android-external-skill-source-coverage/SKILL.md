...
Use when routed to `platforms/android/android-external-skill-source-coverage.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/android/android-external-skill-source-coverage.md`.
...
- Do not treat the compatibility path `platforms/android/android-external-skill-source-coverage.md` as the canonical context-loading target.
