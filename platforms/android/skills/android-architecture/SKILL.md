---
keyflow_id: sys_platforms_android_android_architecture_md_skill
status: review
type: ai-generated
---
...
Use when routed to `platforms/android/android-architecture.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/android/android-architecture.md`.
...
- Do not treat the compatibility path `platforms/android/android-architecture.md` as the canonical context-loading target.
