...
Use when routed to `platforms/android/android-compose-ui.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `platforms/android/android-compose-ui.md`.
...
- Do not treat the compatibility path `platforms/android/android-compose-ui.md` as the canonical context-loading target.
