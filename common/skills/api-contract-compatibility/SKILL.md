---
keyflow_id: sys_common_api_contract_compatibility_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/api-contract-compatibility.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/api-contract-compatibility.md`.
...
- Do not treat the compatibility path `common/api-contract-compatibility.md` as the canonical context-loading target.
