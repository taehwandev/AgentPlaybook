---
keyflow_id: sys_common_web_deployment_versioning_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/web-deployment-versioning.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/web-deployment-versioning.md`.
...
- Do not treat the compatibility path `common/web-deployment-versioning.md` as the canonical context-loading target.
