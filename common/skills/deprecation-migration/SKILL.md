---
keyflow_id: sys_common_deprecation_migration_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/deprecation-migration.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/deprecation-migration.md`.
...
- Do not treat the compatibility path `common/deprecation-migration.md` as the canonical context-loading target.
