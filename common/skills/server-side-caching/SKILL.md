---
keyflow_id: sys_common_server_side_caching_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/server-side-caching.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/server-side-caching.md`.
...
- Do not treat the compatibility path `common/server-side-caching.md` as the canonical context-loading target.
