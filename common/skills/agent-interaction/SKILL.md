---
keyflow_id: sys_common_agent_interaction_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/agent-interaction.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/agent-interaction.md`.
...
- Do not treat the compatibility path `common/agent-interaction.md` as the canonical context-loading target.
