---
keyflow_id: sys_common_scenario_driven_testing_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/scenario-driven-testing.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/scenario-driven-testing.md`.
...
- Do not treat the compatibility path `common/scenario-driven-testing.md` as the canonical context-loading target.
