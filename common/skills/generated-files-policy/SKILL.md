---
keyflow_id: sys_common_generated_files_policy_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/generated-files-policy.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/generated-files-policy.md`.
...
- Do not treat the compatibility path `common/generated-files-policy.md` as the canonical context-loading target.
