---
keyflow_id: sys_common_release_deployment_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/release-deployment.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/release-deployment.md`.
...
- Do not treat the compatibility path `common/release-deployment.md` as the canonical context-loading target.
