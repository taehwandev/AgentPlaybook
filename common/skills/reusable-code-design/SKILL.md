---
keyflow_id: sys_common_reusable_code_design_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/reusable-code-design.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/reusable-code-design.md`.
...
- Do not treat the compatibility path `common/reusable-code-design.md` as the canonical context-loading target.
