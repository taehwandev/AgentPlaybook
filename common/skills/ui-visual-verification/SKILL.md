...
Use when routed to `common/ui-visual-verification.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/ui-visual-verification.md`.
...
- Do not treat the compatibility path `common/ui-visual-verification.md` as the canonical context-loading target.
