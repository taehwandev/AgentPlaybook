...
Use when routed to `common/agent-operating-skill.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/agent-operating-skill.md`.
...
- Do not treat the compatibility path `common/agent-operating-skill.md` as the canonical context-loading target.
