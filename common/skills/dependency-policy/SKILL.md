---
keyflow_id: sys_common_dependency_policy_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/dependency-policy.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/dependency-policy.md`.
...
- Do not treat the compatibility path `common/dependency-policy.md` as the canonical context-loading target.
