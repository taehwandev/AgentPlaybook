---
keyflow_id: sys_common_worktree_hygiene_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/worktree-hygiene.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/worktree-hygiene.md`.
...
- Do not treat the compatibility path `common/worktree-hygiene.md` as the canonical context-loading target.
