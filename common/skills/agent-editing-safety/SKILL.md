...
Use when routed to `common/agent-editing-safety.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/agent-editing-safety.md`.
...
- Do not treat the compatibility path `common/agent-editing-safety.md` as the canonical context-loading target.
