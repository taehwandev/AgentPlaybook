---
keyflow_id: sys_common_defensive_boundaries_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/defensive-boundaries.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/defensive-boundaries.md`.
...
- Do not treat the compatibility path `common/defensive-boundaries.md` as the canonical context-loading target.
