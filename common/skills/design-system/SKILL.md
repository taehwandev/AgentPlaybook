...
Use when routed to `common/design-system.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/design-system.md`.
...
- Do not treat the compatibility path `common/design-system.md` as the canonical context-loading target.
