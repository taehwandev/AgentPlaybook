...
Use when routed to `common/human-authored-writing.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/human-authored-writing.md`.
...
- Do not treat the compatibility path `common/human-authored-writing.md` as the canonical context-loading target.
