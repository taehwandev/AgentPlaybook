---
keyflow_id: sys_common_state_modeling_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/state-modeling.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/state-modeling.md`.
...
- Do not treat the compatibility path `common/state-modeling.md` as the canonical context-loading target.
