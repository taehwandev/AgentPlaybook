---
keyflow_id: sys_common_secure_development_baseline_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/secure-development-baseline.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/secure-development-baseline.md`.
...
- Do not treat the compatibility path `common/secure-development-baseline.md` as the canonical context-loading target.
