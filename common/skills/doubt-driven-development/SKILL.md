---
keyflow_id: sys_common_doubt_driven_development_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/doubt-driven-development.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/doubt-driven-development.md`.
...
- Do not treat the compatibility path `common/doubt-driven-development.md` as the canonical context-loading target.
