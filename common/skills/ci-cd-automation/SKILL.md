---
keyflow_id: sys_common_ci_cd_automation_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/ci-cd-automation.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/ci-cd-automation.md`.
...
- Do not treat the compatibility path `common/ci-cd-automation.md` as the canonical context-loading target.
