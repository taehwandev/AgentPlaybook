---
keyflow_id: sys_common_observability_error_handling_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/observability-error-handling.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/observability-error-handling.md`.
...
- Do not treat the compatibility path `common/observability-error-handling.md` as the canonical context-loading target.
