---
keyflow_id: sys_common_local_tools_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/local-tools.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/local-tools.md`.
...
- Do not treat the compatibility path `common/local-tools.md` as the canonical context-loading target.
