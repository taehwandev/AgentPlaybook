---
keyflow_id: sys_common_asset_lifecycle_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/asset-lifecycle.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/asset-lifecycle.md`.
...
- Do not treat the compatibility path `common/asset-lifecycle.md` as the canonical context-loading target.
