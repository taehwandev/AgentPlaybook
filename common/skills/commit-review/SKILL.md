---
keyflow_id: sys_common_commit_review_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/commit-review.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/commit-review.md`.
...
- Do not treat the compatibility path `common/commit-review.md` as the canonical context-loading target.
