...
Use when routed to `common/code-structure-ownership.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/code-structure-ownership.md`.
...
- Do not treat the compatibility path `common/code-structure-ownership.md` as the canonical context-loading target.
