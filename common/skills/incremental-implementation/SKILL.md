---
keyflow_id: sys_common_incremental_implementation_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/incremental-implementation.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/incremental-implementation.md`.
...
- Do not treat the compatibility path `common/incremental-implementation.md` as the canonical context-loading target.
