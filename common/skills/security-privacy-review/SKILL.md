---
keyflow_id: sys_common_security_privacy_review_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/security-privacy-review.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/security-privacy-review.md`.
...
- Do not treat the compatibility path `common/security-privacy-review.md` as the canonical context-loading target.
