---
keyflow_id: sys_common_change_size_policy_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/change-size-policy.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/change-size-policy.md`.
...
- Do not treat the compatibility path `common/change-size-policy.md` as the canonical context-loading target.
