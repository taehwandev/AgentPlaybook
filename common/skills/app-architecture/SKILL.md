---
keyflow_id: sys_common_app_architecture_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/app-architecture.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/app-architecture.md`.
...
- Do not treat the compatibility path `common/app-architecture.md` as the canonical context-loading target.
