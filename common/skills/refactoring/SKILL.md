---
keyflow_id: sys_common_refactoring_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/refactoring.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/refactoring.md`.
...
- Do not treat the compatibility path `common/refactoring.md` as the canonical context-loading target.
