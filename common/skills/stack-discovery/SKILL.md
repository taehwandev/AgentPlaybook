---
keyflow_id: sys_common_stack_discovery_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/stack-discovery.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/stack-discovery.md`.
...
- Do not treat the compatibility path `common/stack-discovery.md` as the canonical context-loading target.
