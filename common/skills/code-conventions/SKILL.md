---
keyflow_id: sys_common_code_conventions_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/code-conventions.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/code-conventions.md`.
...
- Do not treat the compatibility path `common/code-conventions.md` as the canonical context-loading target.
