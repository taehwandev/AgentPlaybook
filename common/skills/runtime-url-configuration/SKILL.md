---
keyflow_id: sys_common_runtime_url_configuration_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/runtime-url-configuration.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/runtime-url-configuration.md`.
...
- Do not treat the compatibility path `common/runtime-url-configuration.md` as the canonical context-loading target.
