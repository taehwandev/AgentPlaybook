---
keyflow_id: sys_common_project_naming_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/project-naming.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/project-naming.md`.
...
- Do not treat the compatibility path `common/project-naming.md` as the canonical context-loading target.
