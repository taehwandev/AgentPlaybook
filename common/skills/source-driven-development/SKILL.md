---
keyflow_id: sys_common_source_driven_development_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/source-driven-development.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/source-driven-development.md`.
...
- Do not treat the compatibility path `common/source-driven-development.md` as the canonical context-loading target.
