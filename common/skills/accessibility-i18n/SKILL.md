---
keyflow_id: sys_common_accessibility_i18n_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/accessibility-i18n.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/accessibility-i18n.md`.
...
- Do not treat the compatibility path `common/accessibility-i18n.md` as the canonical context-loading target.
