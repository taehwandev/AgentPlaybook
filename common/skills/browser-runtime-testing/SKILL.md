---
keyflow_id: sys_common_browser_runtime_testing_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/browser-runtime-testing.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/browser-runtime-testing.md`.
...
- Do not treat the compatibility path `common/browser-runtime-testing.md` as the canonical context-loading target.
