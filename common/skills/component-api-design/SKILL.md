...
Use when routed to `common/component-api-design.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/component-api-design.md`.
...
- Do not treat the compatibility path `common/component-api-design.md` as the canonical context-loading target.
