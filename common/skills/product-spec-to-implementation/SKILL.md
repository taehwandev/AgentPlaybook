---
keyflow_id: sys_common_product_spec_to_implementation_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/product-spec-to-implementation.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/product-spec-to-implementation.md`.
...
- Do not treat the compatibility path `common/product-spec-to-implementation.md` as the canonical context-loading target.
