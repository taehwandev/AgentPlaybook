---
keyflow_id: sys_common_definition_of_done_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/definition-of-done.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/definition-of-done.md`.
...
- Do not treat the compatibility path `common/definition-of-done.md` as the canonical context-loading target.
