---
keyflow_id: sys_common_architecture_design_md_skill
status: review
type: ai-generated
---
...
Use when routed to `common/architecture-design.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `common/architecture-design.md`.
...
- Do not treat the compatibility path `common/architecture-design.md` as the canonical context-loading target.
