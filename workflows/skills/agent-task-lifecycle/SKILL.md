...
Use when routed to `workflows/agent-task-lifecycle.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/agent-task-lifecycle.md`.
...
- Do not treat the compatibility path `workflows/agent-task-lifecycle.md` as the canonical context-loading target.
