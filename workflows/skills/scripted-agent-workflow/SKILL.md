---
keyflow_id: sys_workflows_scripted_agent_workflow_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/scripted-agent-workflow.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/scripted-agent-workflow.md`.
...
- Do not treat the compatibility path `workflows/scripted-agent-workflow.md` as the canonical context-loading target.
