...
Use when routed to `workflows/ambiguity-gate.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/ambiguity-gate.md`.
...
- Do not treat the compatibility path `workflows/ambiguity-gate.md` as the canonical context-loading target.
