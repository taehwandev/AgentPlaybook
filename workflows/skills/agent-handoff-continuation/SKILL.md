---
keyflow_id: sys_workflows_agent_handoff_continuation_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/agent-handoff-continuation.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/agent-handoff-continuation.md`.
...
- Do not treat the compatibility path `workflows/agent-handoff-continuation.md` as the canonical context-loading target.
