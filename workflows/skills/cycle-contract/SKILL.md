---
keyflow_id: sys_workflows_cycle_contract_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/cycle-contract.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/cycle-contract.md`.
...
- Do not treat the compatibility path `workflows/cycle-contract.md` as the canonical context-loading target.
