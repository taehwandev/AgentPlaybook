---
keyflow_id: sys_workflows_feature_implementation_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/feature-implementation.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/feature-implementation.md`.
...
- Do not treat the compatibility path `workflows/feature-implementation.md` as the canonical context-loading target.
