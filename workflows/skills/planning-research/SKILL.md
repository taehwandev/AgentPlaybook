---
keyflow_id: sys_workflows_planning_research_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/planning-research.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/planning-research.md`.
...
- Do not treat the compatibility path `workflows/planning-research.md` as the canonical context-loading target.
