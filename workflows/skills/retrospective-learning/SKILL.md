...
Use when routed to `workflows/retrospective-learning.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/retrospective-learning.md`.
...
- Do not treat the compatibility path `workflows/retrospective-learning.md` as the canonical context-loading target.
