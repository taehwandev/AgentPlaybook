---
keyflow_id: sys_workflows_prd_creation_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/prd-creation.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/prd-creation.md`.
...
- Do not treat the compatibility path `workflows/prd-creation.md` as the canonical context-loading target.
