...
Use when routed to `workflows/multi-agent-collaboration.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/multi-agent-collaboration.md`.
...
- Do not treat the compatibility path `workflows/multi-agent-collaboration.md` as the canonical context-loading target.
