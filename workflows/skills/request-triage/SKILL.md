---
keyflow_id: sys_workflows_request_triage_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/request-triage.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/request-triage.md`.
...
- Do not treat the compatibility path `workflows/request-triage.md` as the canonical context-loading target.
