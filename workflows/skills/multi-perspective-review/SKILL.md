---
keyflow_id: sys_workflows_multi_perspective_review_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/multi-perspective-review.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/multi-perspective-review.md`.
...
- Do not treat the compatibility path `workflows/multi-perspective-review.md` as the canonical context-loading target.
