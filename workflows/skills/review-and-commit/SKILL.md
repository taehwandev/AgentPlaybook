...
Use when routed to `workflows/review-and-commit.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/review-and-commit.md`.
...
- Do not treat the compatibility path `workflows/review-and-commit.md` as the canonical context-loading target.
