---
keyflow_id: sys_workflows_refactor_cleanup_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/refactor-cleanup.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/refactor-cleanup.md`.
...
- Do not treat the compatibility path `workflows/refactor-cleanup.md` as the canonical context-loading target.
