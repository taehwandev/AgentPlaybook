---
keyflow_id: sys_workflows_development_cycle_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/development-cycle.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/development-cycle.md`.
...
- Do not treat the compatibility path `workflows/development-cycle.md` as the canonical context-loading target.
