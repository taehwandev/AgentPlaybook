---
keyflow_id: sys_workflows_documentation_update_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/documentation-update.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/documentation-update.md`.
...
- Do not treat the compatibility path `workflows/documentation-update.md` as the canonical context-loading target.
