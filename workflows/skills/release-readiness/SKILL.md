---
keyflow_id: sys_workflows_release_readiness_md_skill
status: review
type: ai-generated
---
...
Use when routed to `workflows/release-readiness.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `workflows/release-readiness.md`.
...
- Do not treat the compatibility path `workflows/release-readiness.md` as the canonical context-loading target.
