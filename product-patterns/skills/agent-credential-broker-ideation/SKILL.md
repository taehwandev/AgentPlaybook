---
keyflow_id: sys_product_patterns_agent_credential_broker_ideation_md_skill
status: review
type: ai-generated
---
...
Use when routed to `product-patterns/agent-credential-broker-ideation.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `product-patterns/agent-credential-broker-ideation.md`.
...
- Do not treat the compatibility path `product-patterns/agent-credential-broker-ideation.md` as the canonical context-loading target.
