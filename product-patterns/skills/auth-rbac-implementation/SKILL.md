---
keyflow_id: sys_product_patterns_auth_rbac_implementation_md_skill
status: review
type: ai-generated
---
...
Use when routed to `product-patterns/skills/auth-rbac-implementation/SKILL.md` or when work needs this AgentPlaybook guidance area.
