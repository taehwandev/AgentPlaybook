---
keyflow_id: sys_product_patterns_billing_entitlements_md_skill
status: review
type: ai-generated
---
...
Use when routed to `product-patterns/billing-entitlements.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `product-patterns/billing-entitlements.md`.
...
- Do not treat the compatibility path `product-patterns/billing-entitlements.md` as the canonical context-loading target.
