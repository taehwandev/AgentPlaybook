---
keyflow_id: sys_product_patterns_invitation_implementation_md_skill
status: review
type: ai-generated
---
...
Use when routed to `product-patterns/invitation-implementation.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `product-patterns/invitation-implementation.md`.
...
- Do not treat the compatibility path `product-patterns/invitation-implementation.md` as the canonical context-loading target.
