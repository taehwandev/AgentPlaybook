---
keyflow_id: sys_product_patterns_billing_entitlements_implementation_md_skill
status: review
type: ai-generated
---
...
Use when routed to `product-patterns/billing-entitlements-implementation.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `product-patterns/billing-entitlements-implementation.md`.
...
- Do not treat the compatibility path `product-patterns/billing-entitlements-implementation.md` as the canonical context-loading target.
