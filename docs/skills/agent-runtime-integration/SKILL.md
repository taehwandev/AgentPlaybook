...
Use when routed to `docs/agent-runtime-integration.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `docs/agent-runtime-integration.md`.
...
- Do not treat the compatibility path `docs/agent-runtime-integration.md` as the canonical context-loading target.
