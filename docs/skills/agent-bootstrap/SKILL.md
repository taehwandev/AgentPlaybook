---
keyflow_id: sys_docs_agent_bootstrap_md_skill
status: review
type: ai-generated
---
...
Use when routed to `docs/agent-bootstrap.md` or when work needs this AgentPlaybook guidance area.

## Read

- `references/current-guidance.md` for the full guidance previously held in `docs/agent-bootstrap.md`.
...
- Do not treat the compatibility path `docs/agent-bootstrap.md` as the canonical context-loading target.
